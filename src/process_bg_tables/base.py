...
from configs import YEAR, DATASET_YR

path = F"https://www2.census.gov/programs-surveys/acs/summary_file/{YEAR}/table-based-SF/documentation/Geos2022{DATASET_YR}YR.txt"

geo_df = pd.read_csv(path, sep="|", dtype="str")


def generate_bg_fips_data(geo_df, save_file=False):
...
def generate_state_fips_data(geo_df, save_file=False):
